// @(#)root/test/RootIDE/:$Id: TGRootIDE.cxx 26165 2008-11-12 16:14:03Z bellenot $
...
void TGRootIDE::Build()
{
   ...
   fComboBox->AddEntry("http://irfu.cea.fr/pisp/gentit/SLitrani/", 3);
   fURL->SetText("http://irfu.cea.fr/pisp/gentit/SLitrani/");
   ...
   Selected("http://irfu.cea.fr/pisp/gentit/SLitrani/");
   fGuiHtml->Layout();
