...
clean:
	@del /q $(OBJS) main.$(ObjSuf) VisuLitraniDict.h VisuLitraniDict.$(SrcSuf) *~
	...
	@del /q $(ROOTDEV)\include\TVisuLit.h
...
install:
	...
	@copy TVisuLit.h $(ROOTDEV)\include\TVisuLit.h
...
VisuLitraniDict.$(SrcSuf): $(HDRS)
	...
	@del /q VisuLitraniDict.h VisuLitraniDict.$(SrcSuf) VisuLitraniDict.obj
