{
  ...
  gROOT->ProcessLine(".x InitLitrani.C(2,name,listing,upcom,downcom,kFALSE,kFALSE,kTRUE)");
//
//   DAMANIBM1
//
//  DamAnibm1.C is identical to Anibmm1.C, except that radiation damages have been
//added to the pbwo4 crystal, using ShowerDamage(), describing damages made by
//gammas or electrons.
//  DamAnibm1.C is an example of a setup with a crystal of PbWO4 having the shape
...
//into the ROOT file "DamAnibm1.root". z is xparam, the parameter which varies from run to
