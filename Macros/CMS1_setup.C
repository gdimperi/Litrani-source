...
//  CMS1_setup.C
//
// CMS1_setup.C is a description of the final setup for a crystal of the CMS experiment.
...
//by particles.
  ...
  if (diffusionlength>0.0) pbwo4->SetDiffusionLength(diffusionlength);
//
