{
  char *name    = "Anibm1";
  char *listing = "Anibm1";
  char *upcom   = "Setup with beam of muons and APD";
...
//   ANIBM1
//
//  Anibm1.C is an example of a setup with a crystal of PbWO4 having the shape
...
//by particles.
  ...
  Short_t kMet;
  cout << endl;
  cout << "Please choose between the following methods" << endl;
  cout << " to define fluorescence" << endl;
  cout << endl;
  cout << " (1) - Using Spectrum_PbWO4La to be found in SpectraDB.rdb" << endl;
  cout << " (2) - Using Spectrum_PbWO4La not using SpectraDB.rdb"      << endl;
  cout << " (3) - Using Spectrum_PbWO4Nb to be found in SpectraDB.rdb" << endl;
  cout << " (4) - Using Spectrum_PbWO4Nb not using SpectraDB.rdb"      << endl;
  cout << " (5) - Using old 2 peaks spectrum, new method"              << endl;
  cout << " (6) - Using old 2 peaks spectrum, obsolete FluoComponent"  << endl;
  cout << endl;
  ...
  switch (kMet) {
    ...
    case 1:
      ...
      break;
    case 2:
      pbwo4->FindSpectrum("Spectrum_PbWO4Nb");
      break;
    case 3:
...
//
// Start run 100, generating 4 particle (feel free to generate more !). Recording of
...
//into the ROOT file "Anibm1.root". z is xparam, the parameter which varies from run to
//run and will be used as x axis in the histograms done by the class TPublication.
    pbeam->Gen(100+i,4,z,kTRUE,kFALSE);
    delete pbeam;
    z += dz;
//displaces the beam
    center.Set(x,y,z);
