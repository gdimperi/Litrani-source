{
//
// Decomposition into gaussians of the emission spectrum of PbWO4 doped with niobium
// This spectrum has previously been entered into SplineFitDB.rdb has a TSplineFit
//of category 16, with name:
//   "Spectrum_PbWO4Nb" and title
//   "Emission Spectrum | Lead tungstate PbWO4 doped with niobium"
// We give the same name and title to the TLitSpectrum created here.
//
// In the litterature, it is said that PbWO4(Nb) has 2 "components", one at 420nm
...
//addition of the decay times, is called "LitSpectrum_PbWO4Nb.C"
//
  Bool_t ok;
  TLitSpectrum *sp;
  ...
  sp = new TLitSpectrum("Spectrum_PbWO4Nb","Emission Spectrum | Lead tungstate PbWO4 doped with niobium",kTRUE);
  mean[0]      = 420.0;
  mean[1]      = 500.0;
  mean[2]      = 400.0;
  mean[3]      = 520.0;
