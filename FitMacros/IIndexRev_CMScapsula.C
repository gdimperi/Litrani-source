TSplineFit* IIndexRev_CMScapsula(Bool_t todraw = kFALSE,Bool_t infile = kFALSE,Bool_t firstinfile = kFALSE)
//
// Arguments:
//
...
//
//   IIndexRev_CMScapsula
//
//   Im. part of index of refraction for CMS capsula in function of wavelength
...
//
{
  ...
  IIndexRevCaps = new TSplineFit("IIndexRev_CMScapsula","Im.  part of refraction index | CMS capsula",
    4,M,m,x,y,sig,kTRUE,0.0,kFALSE,10.0,300.0,1000.0);
  IIndexRevCaps->SetSource("No Source yet. Values for aluminium taken");
  IIndexRevCaps->SetMacro("IIndexRev_CMScapsula.C");
