// @(#)root/html:$Id: TSplineFit.cxx 2008-06-11
...
<h3>Introduction</h3>
<div align="left">
<p><b><code>SplineFit</code> is much more than a tool allowing fits of splines. 
It is conceived as a general solution for the handling of variable parameters inside 
an application.&nbsp;</b>Let us take the example of a Monte-Carlo of optical photons, 
like <a href="http://gentit.home.cern.ch/gentit/litrani/"><code><b>Litrani</b></code></a>. 
There, variable parameters may be: index of refraction, absorption length, diffusion 
length, which vary according to wavelength. Or gain profile of APD which varies according 
to distance in <font face="Symbol">m</font>m, and so on For each of these variable 
quantities, one has generally at hand a series of measurements, for instance taken 
from the &quot;<i>Handbook of Optical Constants</i>&quot;.&nbsp;The problem is to 
go from these measurements towards a method for getting a fitted value for any of 
the values of the parameter like wavelength or depth or whatsoever. <b><code>SplineFit</code></b> 
...
<ul>
<li><b><code>SplineFit</code></b> must cope with any kind of data structure.&nbsp;This 
is where fits of spline are much more interesting than for instance fits of polynoms. 
It is a well known fact that fits of polynoms fail when tried on a complicated data 
structure.&nbsp;Increasing the degree of the fit lead to bigger matrices, whose inversion 
very soon fails. It is why polynomial fits in <a href="http://root.cern.ch/"><b><code>ROOT</code></b></a> 
are limited to the 9th degree. Spline fits also lead to matrix inversion, but here 
the matrix has the very nice property of being a band matrix. Spline fits with a 
band matrix of size up to 4000 do succeed! In the old <a href="http://gentit.home.cern.ch/gentit/litrani/"><code><b>Litrani</b></code></a>, 
where polynomial fits were used, we had to replace fits with interpolation each time 
the polynomial fit failed.&nbsp;This was an annoyance since an interpolation instead 
of a fit does not smooth anymore the statistical fluctuations or errors on measurements.				<li><b><code>SplineFit</code></b> 
...
categories</b>.&nbsp;Take the example quoted above for the use in <a href="http://gentit.home.cern.ch/gentit/litrani/"><code><b>Litrani</b></code></a>: 
index of refraction, absorption length, diffusion length, and so on.					<li><b>Inside 
a given category, when fits are identical up to only one differing 
...
See library <b><code><a href="http://gentit.home.cern.ch/gentit/litrani/AllModules/SplineFitCode/TSplineFit.html">libTwoPad</a></code></b>.				</ul>
...
and on the mathematics behind <b><code>SplineFit</code></b>.</p>
<p></p>
</div>
<div align="center">
...
<div align="left">
<p></p>
<p><b><code>SplineFit</code></b> is written in C++ and constructed upon <a href="http://root.cern.ch/"><b><code>Root</code></b></a>, 
...
<tr>
<td><b><code>TSplineFit</code></b></td>
<td><code><b>this class, the main one</b></code></td>
</tr>
<tr>
<td><b><a href="TBandedLE.html"><code>TBandedLE</code></a></b></td>
<td><code><b>solution of linear systems with band matrix</b></code></td>
</tr>
<tr>
<td><b><a href="TZigZag.html"><code>TZigZag</code></a></b></td>
<td><code><b>allowing extension to 2D or 3D fits</b></code></td>
</tr>
<tr>
<td><code><b><a href="TPoly3.html">TPoly3</a></b></code></td>
<td><code><b>Handling of 3rd order polynomials</b></code></td>
</tr>
</table>
</div>
<div align="left">
...
<div align="left">
<p>There are 9 different constructors of the class <code><b>TSplineFit</b></code>. 
Choice of the right constructor allow to:</p>
<ul>
<li>choose among 1D, 2D or 3D fits
<li>choose among spline fits or spline interpolation or linear interpolation
<li>choose among entering data under the form of <b>real arrays</b>, <b><a href="http://root.cern.ch/root/html/TGraphErrors.html"><code>TGraphErrors</code></a></b>, 

or <b><a href="http://root.cern.ch/root/html/TH1D.html"><code>histograms</code></a></b>.
</ul>
<p>The use of <b><code>SplineFit</code></b> for 2D or 3D fits is explained below.</p>
<p>The call to the constructor finds the solution of the problem by calling <b><a href="TBandedLE.html"><code>TBandedLE</code></a></b>, 
except when spline interpolation is asked, where it simply calls the <a href="http://root.cern.ch/"><b><code>ROOT</code></b></a> 
class <b><a href="http://root.cern.ch/root/html/TSpline3.html"><code>TSpline3</code></a></b>, 
...
by a call to <code><b><a href="TBandedLE.html#TBandedLE:Verify">TBandedLE::Verify</a></b>()</code>. 
...
fit.</p>
<p>If you want to get the value of the fit at x, call <b><code><a href="#TSplineFit:V">TSplineFit::V(x)</a></code></b>. 

For 2D or 3D fits, call <b><code><a href="#TSplineFit:V">TSplineFit::V(x,y)</a></code></b> 
or <b><code><a href="#TSplineFit:V">TSplineFit::V(x,y,z)</a></code></b>.</p>
<p></p>
<p></p>
</div>
<div align="center">
...
<li>calling <b><code><a href="#TSplineFit:SetSource">TSplineFit::SetSource()</a></code></b> 
allows you to store the information of where you got the measurements from.					<li>calling 
<b><code><a href="#TSplineFit:SetMacro">TSplineFit::SetMacro()</a></code></b> allows 
you to store the name of the <b><code>CINT</code></b> 
macro having produced the fit.					<li>calling <b><code><a href="#TSplineFit:SetXLabel">TSplineFit::SetXLabel()</a></code></b> 
[<b><code><a href="#TSplineFit:SetYLabel">SetYLabel()</a></code></b> 
or <b><code><a href="#TSplineFit:SetZLabel">SetZLabel()</a></code></b> for 2D or 
3D fits] allows you to store the information in function 
of what quantity is the fit varying.&nbsp;For instance &quot;wavelength [nm]&quot; 

for an index of refraction.
<li>calling <b><code><a href="#TSplineFit:SetVLabel">TSplineFit::SetVLabel()</a></code></b> 
stores the information of what is the variable quantity, for example &quot;index 
of refraction&quot;					<li>calling <b><code><a href="#TSplineFit:SetDefaultLabels">TSplineFit::SetDefaultLabels()</a></code></b> 
will add to the display of the fit the 2 following informations:			</div>
<ul>
<div align="left">
<li>label1 : source of measurements for this fit, given by <b><code><a href="#TSplineFit:SetSource">TSplineFit::SetSource()</a></code></b>
<li>label2 : name of the <b><code>CINT</code></b> macro having produced this 
fit, given by <b><code><a href="#TSplineFit:SetMacro">TSplineFit::SetMacro()</a></code></b>
</div>
</ul>
</ul>
<div align="left">
<p>After the fit is totally defined, you can call method <b><code><a href="#TSplineFit:Print">TSplineFit::Print()</a></code></b> 
...
has been set to <b><code>0.5*e-3</code></b>.&nbsp;The smaller <b><code>eps</code></b> 
is chosen, the bigger the perturbation affecting the fit.&nbsp;Going towards 0 for 
...
give values above <b><code>yup</code></b>. It is only when calling method <b><code><a href="#TSplineFit:V">TSplineFit::V()</a></code></b> 
...
<div align="left">
<p>One of the arguments of the constructor of <b><code>TSplineFit</code></b> 
is the number of measurements to take per spline (per sub-interval containing one 
spline). The less this number of measurements, the greatest the number of splines 
to use, but the closer to the measurements is the fit.&nbsp;You can play with this 
parameter until the fit looks good for you or until the chi2 of the fit is close 
to 1. If you happen to ask for only one measurement per spline, then <b><code>TSplineFit</code></b> 
understands that you do not want a fit, but an interpolation.&nbsp;The machinery 
of<code> <b><a href="TBandedLE.html">TBandedLE</a></b></code> 
is then <b>not</b> used.&nbsp;Instead, the <a href="http://root.cern.ch/"><b><code>ROOT</code></b></a> 
class <b><code><a href="http://root.cern.ch/root/html/TSpline3.html">TSpline3</a></code></b> 


is called. In case of interpolation instead of fit, the provided values for the errors 


on <code><b>y[i]</b></code> are irrelevant. Be aware also that some methods of <b><code>TSplineFit</code></b>, 
like <b><code><a href="#TSplineFit:MinMax">TSplineFit::MinMax()</a></code></b>, do 
not work in case of interpolation.</p>
<p></p>
</div>
<div align="center">
...
<div align="left">
<p>The clas <b><code>TSplineFit</code></b> derives from <b><a href="http://root.cern.ch/root/html/TNamed.html"><code>TNamed</code></a></b>, 
...
instance in the table below what are the different categories of fits used in <a href="http://gentit.home.cern.ch/gentit/litrani/"><code><b>Litrani</b></code></a>. 
If you intend to use <b><code>TSplineFit</code></b> independently of <a href="http://gentit.home.cern.ch/gentit/litrani/"><code><b>Litrani</b></code></a>, 
you are free to define names and titles of all categories.&nbsp;If you intend to 
use it also with <a href="http://gentit.home.cern.ch/gentit/litrani/"><code><b>Litrani</b></code></a>, 
please do not change names and titles for categories 1 to 20, as given in the table 
below. And do not define names and titles for categories 20-30, which are reserved 
for <a href="http://gentit.home.cern.ch/gentit/litrani/"><code><b>Litrani</b></code></a>. 
You can freely use categories 31 to 99.</p>
...
to use <b><code>SplineFit</code></b> without the database.</p>
<p></p>
</div>
...
<td>
<div align="center">
<h3><font color="#b22222"><b><code>Name</code></b></font></h3>
</div>
</td>
<td>
<div align="center">
<h3><font color="#b22222"><b><code>Title</code></b></font></h3>
</div>
</td>
<td>
<div align="center">
<h3><font color="#b22222"><b><code>Nb.</code></b></font></h3>
</div>
</td>
<td>
<div align="center">
<h3><font color="#b22222"><b><code>variation according</code></b></font></h3>
</div>
</td>
</tr>
<tr>
<td><b><code>miscellaneous</code></b></td>
<td><b><code>miscellaneous</code></b></td>
<td><b><code>0</code></b></td>
<td><b><code>anything</code></b></td>
</tr>
<tr>
<td><b><code>RefrIndex</code></b></td>
<td><b><code>Index of refraction</code></b></td>
<td><b><code>1</code></b></td>
<td><b><code>wavelength</code></b></td>
</tr>
<tr>
<td><b><code>DielTensor</code></b></td>
<td><b><code>Element of dielectric tensor</code></b></td>
<td><b><code>2</code></b></td>
<td><b><code>wavelength</code></b></td>
</tr>
<tr>
<td><b><code>RIndexRev</code></b></td>
<td><b><code>Real part of refraction index</code></b></td>
<td><b><code>3</code></b></td>
<td><b><code>wavelength</code></b></td>
</tr>
<tr>
<td><b><code>IIndexRev</code></b></td>
<td><b><code>Im. part of refraction index</code></b></td>
<td><b><code>4</code></b></td>
<td><b><code>wavelength</code></b></td>
</tr>
<tr>
<td><b><code>AbsorptionLength</code></b></td>
<td><b><code>Absorption Length</code></b></td>
<td><b><code>5</code></b></td>
<td><b><code>wavelength</code></b></td>
</tr>
<tr>
<td><b><code>AbsLengthTensor</code></b></td>
<td><b><code>Element of absorption length tensor</code></b></td>
<td><b><code>6</code></b></td>
<td><b><code>wavelength</code></b></td>
</tr>
<tr>
<td><b><code>DiffusionLength</code></b></td>
<td><b><code>Diffusion Length</code></b></td>
<td><b><code>7</code></b></td>
<td><b><code>wavelength</code></b></td>
</tr>
<tr>
<td><b><code>DiffLengthTensor</code></b></td>
<td><b><code>Element of diffusion length tensor</code></b></td>
<td><b><code>8</code></b></td>
<td><b><code>wavelength</code></b></td>
</tr>
<tr>
<td><b><code>DiffVersusReflec</code></b></td>
<td><b><code>Proportion of diffusion versus reflection</code></b></td>
<td><b><code>9</code></b></td>
<td><b><code>%</code></b></td>
</tr>
<tr>
<td><b><code>QuantumEff</code></b></td>
<td><b><code>Quantum efficiency</code></b></td>
<td><b><code>10</code></b></td>
<td><b><code>0&lt;--&gt;1</code></b></td>
</tr>
<tr>
<td><b><code>Dedx</code></b></td>
<td><b><code>Energy deposited by crossing</code></b></td>
<td><b><code>11</code></b></td>
<td><b><code>- or energy</code></b></td>
</tr>
<tr>
<td><b><code>AngularDistrib</code></b></td>
<td><b><code>Angular distribution of photons</code></b></td>
<td><b><code>12</code></b></td>
<td><b><code>radian</code></b></td>
</tr>
<tr>
<td><b><code>GainProfile</code></b></td>
<td><b><code>Gain profile of APD or PIN</code></b></td>
<td><b><code>13</code></b></td>
<td><b><code>depth</code></b></td>
</tr>
<tr>
<td><b><code>Permeability</code></b></td>
<td><b><code>Magnetic perpeability mu</code></b></td>
<td><b><code>14</code></b></td>
<td><b><code>wavelength</code></b></td>
</tr>
<tr>
<td><b><code>RadDamage</code></b></td>
<td><b><code>Radiation damages in shape</code></b></td>
<td><b><code>15</code></b></td>
<td><b><code>wavelength or depth</code></b></td>
</tr>
<tr>
<td><b><code>Spectrum</code></b></td>
<td><b><code>Light emission spectrum</code></b></td>
<td><b><code>16</code></b></td>
<td><b><code>wavelength</code></b></td>
</tr>
<tr>
<td><b><code>NPLY</code></b></td>
<td><b><code>Non proportionality of light yield</code></b></td>
<td><b><code>17</code></b></td>
<td><b><code>energy [Mev]</code></b></td>
</tr>
<tr>
<td><b><code>PhotoEl</code></b></td>
<td><b><code>Photo-Electric Cross Section</code></b></td>
<td><b><code>18</code></b></td>
<td><b><code>energy [Mev]</code></b></td>
</tr>
<tr>
<td><b><code>Rayleigh</code></b></td>
<td><b><code>Rayleigh length</code></b></td>
<td><b><code>19</code></b></td>
<td><b><code>wavelength</code></b></td>
</tr>
<tr>
<td><code><b>AbsLengthWLS</b></code></td>
<td><code><b>Absorption Length for WLS</b></code></td>
<td><code><b>20</b></code></td>
<td><code><b>wavelength</b></code></td>
</tr>
</table>
<div align="left">
<p></p>
...
4 for imaginary part of index of refraction of wrappings and call the 2 <b><code>TSplineFit</code></b> 
like this:</p>
<ul>
...
<div align="center">
<div align="left">
<p>Look at methods: <b><code><a href="#TSplineFit:BelongsToFamily">TSplineFit::BelongsToFamily()</a></code></b><code><b>, 
<a href="#TSplineFit:FindFirstInFamily">TSplineFit::FindFirstInFamily()</a>, <a href="#TSplineFit:FindFitInFamily">TSplineFit::FindFitInFamily()</a>, 
<a href="#TSplineFit:LoadFamily">TSplineFit::LoadFamily()</a></b><b>, </b></code><a href="#TSplineFit:V"><code><b>TSplineFit::</b><b>V(Int_t,Double_t,Double_t)</b></code></a><code><b>, 
<a href="#TSplineFit:GetRandom">TSplineFit::GetRandom(.,.,.)</a>.</b></code></p>
</div>
</div>
</div>
...
same name)
<li>for each fit of the family, call <b><code><a href="#TSplineFit:BelongsToFamily">TSplineFit::BelongsToFamily()</a></code></b>, 
with 1st argument <b>k</b> from <b>0</b> to <b>n-1</b>, where<b> n</b> is the number 

of elements in the family, 4 in our example.
<li>the second argument of <b><code><a href="#TSplineFit:BelongsToFamily">TSplineFit::BelongsToFamily()</a></code></b> 
is some parameter which changes going from one element of the family to the others. 
In our example, the percentage of lead.						<li>the third argument of <b><code><a href="#TSplineFit:BelongsToFamily">TSplineFit::BelongsToFamily()</a></code></b> 
is some text explaining what the second argument is.					</ul>
...
<p>After these calls to <b><code><a href="#TSplineFit:BelongsToFamily">TSplineFit::BelongsToFamily()</a></code></b> 
are done, the names of the 4 fits will be:</p>
<ul>
...
version of <b><code><a href="#TSplineFit:GetRandom">TSplineFit::GetRandom()</a></code></b> 
reserved for families of fits, the fit inside the family which has a parameter closest 
to 25 Gev will be chosen to generate the random number.</p>
<p></p>
...
<p>Then you will be able to call <b><code><a href="#TSplineFit:V">TSplineFit::V(N,x,p)</a></code></b> 
or <b><code><a href="#TSplineFit:GetRandom">TSplineFit::GetRandom(N,p)</a></code></b>.</p>
<p></p>
</div>
</div>
</div>
...
<div align="center">
<div align="left">
<p>All fits defined in an application using <b><code>SplineFit</code></b> are 
held into 
an ordered collection (static variable <code><b>TSplineFit::fgFits</b></code>) and 
may be retrieved at will. All constructors of <b><code>TSplineFit</code></b>, except 
the default constructor, put the fit into the collection <code><b>TSplineFit::fgFits</b></code>. 
<b><code>TSplineFit</code></b> allows also, with the method <b><code><a href="#TSplineFit:UpdateFile">TSplineFit::UpdateFile()</a></code></b>, 
to build a kind of database in the form of a <a href="http://root.cern.ch/"><b><code>Root</code></b></a> 
file, where the fit is searched for (static method <b><code><a href="#TSplineFit:FindFit">TSplineFit::FindFit()</a></code></b>) 
...
can be retrieved later on in the program by the method <b><code><a href="#TSplineFit:FindFit">TSplineFit::FindFit()</a></code></b>, 
giving name and (optionnaly) category of the fit. The retrieval is faster if you 
give the category. If the fit is not in the collection <code><b>TSplineFit::fgFits</b></code>, 
a <a href="http://root.cern.ch/"><b><code>Root</code></b></a> &quot;database&quot; 
file is searched and if found in the database, the fit is inserted into the collection. 
This allows to define fits once for all, which are at hand for many different programs. 
We improperly call it a database file, although it is simply a <a href="http://root.cern.ch/"><b><code>Root</code></b></a> 
file, because we have implemented in <b><code>TSplineFit</code></b> methods to retrieve 
specific elements [<b><code><a href="#TSplineFit:FindFit">TSplineFit::FindFit()</a></code></b>], 
to delete specific elements [<b><code><a href="#TSplineFit:RemoveFitFromFile">TSplineFit::RemoveFitFromFile()</a></code></b>] 
and methods to order elements in the file [<b><code><a href="#TSplineFit:OrderFile">TSplineFit::OrderFile()</a></code></b>].&nbsp;We 
have given the extension <b><code>.rdb</code></b> and not <b><code>.root</code></b> 
to this 
...
<p>So when unpacking code and source of <b>SplineFit</b>, look at the file <code><b>SplineFitDB.rdb</b></code> 
in the directory &quot;<code><b>database</b></code>&quot; and place it into the same 
directory in which you intend to launch the application using <b>SplineFit</b> :</p>
<ul>
<li>in the same directory as <b><code>SplineFit.exe</code></b> if you intend 
to launch <b><code>SplineFit.exe</code></b>,					<li>or in the same directory as 
<b><code>Litrani.exe</code></b>, if you intend to launch <a href="http://gentit.home.cern.ch/gentit/litrani/"><code><b>Litrani</b></code></a>.				<li>or 
in the same directory as your application, if your application is using <b><code>SplineFit</code></b>.				</ul>
<p>By that you will inherit of all fits allowing the examples of use of <a href="http://gentit.home.cern.ch/gentit/litrani/"><code><b>Litrani</b></code></a> 
...
use the method <b><code><a href="#TSplineFit:UpdateFile">TSplineFit::UpdateFile(Bool_t=kFALSE)</a></code></b>. 
Be careful that the argument must be <b><code>kFALSE, </code></b>or absent! Use a 
<b><code>kTRUE</code></b> argument only in the case the database file does not exist 
and you are creating it by entering its first fit! If this fit (or a fit with the 
same name) is already in the database file, it will not be inserted: a check is done 
with the method <b><code><a href="#TSplineFit:VerifyNotInFile">TSplineFit::VerifyNotInFile()</a></code></b><code><b>. 
</b></code>Remember that by convention, a fit of category 0 is <b><font color="#b22222">not</font></b> 
put inside the database file. The static method <code><b><a href="#TSplineFit:ShowFitsInFile">TSplineFit::ShowFitsInFile()</a></b></code> 
prints the list of all fits available in the file. The static method <b><code><a href="#TSplineFit:DrawFitsInFile">TSplineFit::DrawFitsInFile()</a></code></b> 
draws each fit in the file, in turn.</p>
<p>If you are short of memory and your program needs to handle a lot of fits, 
you can call the method <b><code><a href="#TSplineFit:ReduceMemory">TSplineFit::ReduceMemory()</a></code></b>.&nbsp;Calling 
it, you preserve only what is necessary in order to obtain y(x) with the method <b><code><a href="#TSplineFit:V">TSplineFit::V(x)</a></code></b>. 
All measurements, matrices of the problem, are lost. Do never call <b><code><a href="#TSplineFit:ReduceMemory">TSplineFit::ReduceMemory()</a></code></b> 
...
it to be ordered, call the static method <b><code><a href="#TSplineFit:OrderFile">TSplineFit::OrderFile()</a></code></b>. 


If you want to remove a fit from the database file, call the static method <b><code><a href="#TSplineFit:RemoveFitFromFile">TSplineFit::RemoveFitFromFile()</a></code></b>.</p>
<p></p>
</div>
<div align="center">
...
the method <b><code><a href="#TSplineFit:UseForRandom">TSplineFit::UseForRandom()</a></code></b> 
has to be called for allowing it. Notice that the condition is that the fitted distribution 
is never negative, so that the distribution must have been created with a positive 
lower bound. Then, the method <b><code><a href="#TSplineFit:GetRandom">TSplineFit::GetRandom()</a></code></b> 
get a random number according to the fitted distribution.</p>
<p>The method used is to create an histogram <b><code>fHGenRandom</code></b> 
whose bin content is according the fitted distribution and to use the <a href="http://root.cern.ch/"><b><code>Root</code></b></a> 
method <b><code><a href="http://root.cern.ch/root/html/TH1.html#TH1:GetRandom">TH1::GetRandom()</a></code></b>. 
The number of channels of this histogram is 

given by the static variable <code><b>TSplineFit::fgNChanRand</b></code>, which has 
a default value of 128 and can be changed by the user before calling <b><code><a href="#TSplineFit:UseForRandom">TSplineFit::UseForRandom()</a></code></b>. 
To verify that the random numbers are indeed generated according to the fit distribution, 
call the method <b><code><a href="#TSplineFit:ShowRandom">TSplineFit::ShowRandom()</a></code></b>. 
To get a random number according to the fitted distribution, call the method <b><code><a href="#TSplineFit:GetRandom">TSplineFit::GetRandom()</a></code></b>.</p>
...
<div align="left">
<p>A &quot;trick&quot; is used by <b><code>SplineFit</code></b> to extend the 
possibilities 
of <b><code>TSplineFit</code></b> to <b>2D</b> or <b>3D</b>.&nbsp;This trick is explained 
in the 
class description of <b><a href="TZigZag.html"><code>TZigZag</code></a></b>. Be aware 
that it 
...
among the examples of use of <b><code>SplineFit</code></b>. In case of 2D or 3D fits, 
the data to be fitted must be provided in histograms of type <b><a href="http://root.cern.ch/root/html/TH2D.html"><code>TH2D</code></a></b> 

or <b><a href="http://root.cern.ch/root/html/TH3D.html"><code>TH3D</code></a></b>. 
Use the 7th 
...
of use are provided in the directory <b><code>FitMacros</code></b>. In fact, <b><code>FitMacros</code></b> 
contains the definitions of the fits used in the examples of <a href="http://gentit.home.cern.ch/gentit/litrani/"><code><b>Litrani</b></code></a>. 
Each one may serve as an example of use. Let us take <b><code>AbsorptionLength_PbWO4.C</code></b> 
as an example. Look at its code! Notice that calling any constructor of <b><code>TSplineFit</code></b> 
automatically put the fit into the collection <b><code>TSplineFit::fgFits</code></b>, 
so that if it happens to you to have defined a fit, and you want to try it inside 
a <b><code>CINT</code></b> macro <i>before</i> putting it inside the database file 
<b><code>SplineFitDB.rdb</code></b>, simply put inside your <b><code>CINT</code></b> 
macro:</p>
<ul>
<li><b><code>gROOT-&gt;ProcessLine(&quot;.x AbsorptionLength_PbWO4.C();&quot;);</code></b>
</ul>
<p>It will then be in the collection  <b><code>TSplineFit::fgFits</code></b>, 
and will be found by <b><code>TSplineFit::FindFit()</code></b> without opening the 
database file <b><code>SplineFitDB.rdb</code></b>.</p>
<p>For instance,</p>
<ul>
<div align="center">
<div align="left">
<li>if you want just that the fit be put inside the collection <b><code>TSplineFit::fgFits</code></b>, 
then type:
</div>
</div>
<ul>
<div align="center">
<div align="left">
<li><b><code>.x AbsorptionLength_PbWO4.C();</code></b>
</div>
</div>
</ul>
<li>if you want a display of the fit, then type:
<ul>
<li><b><code>.x AbsorptionLength_PbWO4.C(kTRUE);</code></b>
</ul>
<li>if you want the fit to be put into the database file <b><code>SplineFitDB.rdb</code></b>, 
type:
<ul>
<li><b><code>.x AbsorptionLength_PbWO4.C(kFALSE,kTRUE);</code></b>
</ul>
</ul>
<p>The database file  can be recreated using the <b><code>CINT</code></b> macro 
<b><code>Rebuild_SplineFitDB.C</code></b>.</p>
<p></p>
<div align="center">
<div align="center">
<h3>Display and quality of the fit</h3>
</div>
<div align="left">
<div align="center">
<div align="left">
<p><b><code>SplineFit</code></b> uses the library<b><code> <a href="http://gentitfx.web.cern.ch/gentitfx/TwoPad/">libTwoPad</a></code></b>, 
the same used by <a href="http://gentit.home.cern.ch/gentit/litrani/"><code><b>Litrani</b></code></a>, 
for its displays. It allows very nice plots and offers the use of buttons. Have a 
look to the class <b><code><a href="http://gentit.home.cern.ch/gentit/litrani/AllModules/TwoPadCode/TwoPadDisplay.html">TwoPadDisplay</a></code></b>. 
<b><code><a href="http://gentitfx.web.cern.ch/gentitfx/TwoPad/">LibTwoPad</a></code></b> 
must be compiled and linked before <b><code>SplineFit</code></b>.</p>
<p></p>
</div>
</div>
<p>In case of 1D, the method <b><code><a href="#TSplineFit:DrawFit">TSplineFit::DrawFit()</a></code></b> 
draws superimposed graph of the measured points and of the fit.</p>
<p>In case of 2D or 3D, call the method <b><code><a href="#TSplineFit:DrawData">TSplineFit::DrawData()</a></code></b> 
to see the data, and then <b><code><a href="#TSplineFit:DrawFit">TSplineFit::DrawFit()</a></code></b> 
to see the fit.</p>
<p>All drawing are done by the class <b><code><a href="http://gentit.home.cern.ch/gentit/litrani/AllModules/TwoPadCode/TwoPadDisplay.html">TwoPadDisplay</a></code></b>. 
A global pointer, <b><code>gTwoPad</code></b> points towards <b><code><a href="http://gentit.home.cern.ch/gentit/litrani/AllModules/TwoPadCode/TwoPadDisplay.html">TwoPadDisplay</a></code></b>. 
...
<ol>
<li>Simply don't care.&nbsp;In that case, <b><code>gTwoPad</code></b> 
will be booked automatically at the first call to a <b><code>Draw..</code></b>. method.&nbsp;In 
that case, you will have all the defaults of <b><code><a href="http://gentit.home.cern.ch/gentit/litrani/AllModules/TwoPadCode/TwoPadDisplay.html">TwoPadDisplay</a></code></b>. 
The 4 labels displayed in addition to the fit will be general labels, not specific 
to the fit displayed.						<li>Just call <b><code><a href="#TSplineFit:SetDefaultLabels">TSplineFit::SetDefaultLabels()</a></code></b>, 
without arguments, from your <b><code>CINT</code></b> code, after the full definition 
of the fit and before 
calling any of the <b><code>Draw..</code></b>.  methods.&nbsp;<b><code>gTwoPad</code></b> 
will be booked by this call, you will have all the defaults of <b><code><a href="http://gentit.home.cern.ch/gentit/litrani/AllModules/TwoPadCode/TwoPadDisplay.html">TwoPadDisplay</a></code></b>, 
but at least 2 of the labels drawn will be specific to the fit						<li>Book <b><code>gTwoPad</code></b> 
yourself from your <b><code>CINT</code></b> code, by a call to the constructor of 
<b><code><a href="http://gentit.home.cern.ch/gentit/litrani/AllModules/TwoPadCode/TwoPadDisplay.html">TwoPadDisplay</a></code></b>.&nbsp;Then 
change all the class variables of <b><code><a href="http://gentit.home.cern.ch/gentit/litrani/AllModules/TwoPadCode/TwoPadDisplay.html">TwoPadDisplay</a></code></b> 
that you want to be changed and call<b><code> gTwoPad-&gt;UpdateCanvas()</code></b>. 
So <b><code><a href="http://gentit.home.cern.ch/gentit/litrani/AllModules/TwoPadCode/TwoPadDisplay.html">TwoPadDisplay</a></code></b> 
will suit your needs and taste.					</ol>
<p> </p>
<p></p>
</div>
</div>
...
<div align="left">
<p>Method <b><code><a href="#TSplineFit:MinMax">TSplineFit::MinMax()</a></code></b> 
finds the lowest among the minima of the fitted distribution, if there is at least 
one minimum, and the biggest among the maxima of the distribution, if there is at 
least one maximum.</p>
<ul>
...
is surely big. Putting it to 0 is totally wrong. A detailed presentation of this 
problem is available <a href="http://gentitfx.web.cern.ch/gentitfx/ErrorsInH/">here</a>.</p>
...
and the formula <code><b>Sqrt(N*</b><font face="Symbol"><b>e</b></font><b><sub>i</sub>*(1-</b><font face="Symbol"><b>e</b></font><b><sub>i</sub>))</b></code>. 
Put these new errors in the histogram using the method <b><code><a href="http://root.cern.ch/root/html/TH1.html#TH1:SetBinError">TH1::SetBinError()</a></code></b>.

<li>then you are able to do fits on the histogram which are not meaningless!!

</ol>
<p>It is exactly what the method <b><code><a href="#TSplineFit:ErrorsFromFit">TSplineFit::ErrorsFromFit()</a></code></b> 
...
the bin is 0. This is done by the method <b><code><a href="#TSplineFit:MultinomialAsWeight">TSplineFit::MultinomialAsWeight()</a></code></b>. 
Then we proceed by iteration. The user is free to repeat the fit as many times as 
he wants, having then better and better errors, and smaller lower limits for the 
errors. The <b><code>CINT</code></b> 
...
TSplineFit::TSplineFit(Text_t *name,Text_t *title,Int_t cat,Int_t M, Int_t m,Double_t *x,
  Double_t *y,Double_t *sig,Bool_t lowbounded,Double_t ylow,Bool_t upbounded,Double_t yup,
  Double_t xmin,Double_t xmax,Bool_t debug):TNamed(name,title) {
  //
...
TSplineFit::TSplineFit(Text_t *name,Text_t *title,Int_t cat,Int_t M,Double_t *x,
  Double_t *y,Double_t xmin,Double_t xmax):TNamed(name,title) {
  //
...
TSplineFit::TSplineFit(Text_t *name,Text_t *title,Int_t cat,Int_t m,TGraphErrors *graph,
  Bool_t lowbounded,Double_t ylow,Bool_t upbounded,Double_t yup,Double_t xmin,
  Double_t xmax,Bool_t debug):TNamed(name,title) {
  //
...
TSplineFit::TSplineFit(Text_t *name,Text_t *title,Int_t cat,Int_t m,TH1D *h,
  Bool_t lowbounded,Double_t ylow,Bool_t upbounded,Double_t yup,
  Bool_t debug):TNamed(name,title) {
  //
...
TSplineFit::TSplineFit(Text_t *name,Text_t *title,Int_t cat,Int_t m,TH2D *h,
  Bool_t lowbounded,Double_t vlow,Bool_t upbounded,Double_t vup,
  Bool_t debug):TNamed(name,title) {
  //
...
TSplineFit::TSplineFit(Text_t *name,Text_t *title,Int_t cat,Int_t m,TH3D *h,
  Bool_t lowbounded,Double_t vlow,Bool_t upbounded,Double_t vup,
  Bool_t debug):TNamed(name,title) {
  //
...
void TSplineFit::DrawFit(Option_t *option,Int_t facx, Int_t facy, Int_t facz) {
  ...
  // DrawData() instead.
  //  The drawing is inside the canvas pointed to by gTwoPad.  gTwoPad is a
  // global pointer towards TwoPadDisplay at your disposal from your CINT code.
  //  It is a good idea to book yourself gTwoPad at the beginning of your CINT
  // code. Doing so, you will be able to specify yourself all the (numerous)
  // characteristics of the canvas and of its pad. All class variables of TwoPadDisplay
  // can be changed. Not doing so, you will be obliged to accept the default values.
  // You can also book gTwoPad by a call to TSplineFit::SetDefaultLabels().
  // TSplineFit::SetDefaultLabels() will replace the default labels of TwoPadDisplay
  // (not specific to this fit) by the default labels specific to this fit. For the other
  // options, you will have the defaults of TwoPadDisplay.
  //  If you choose to book gTwoPad yourself at the beginning of your CINT
  // code, look at the class description of TwoPadDisplay to know how to do.
...
void TSplineFit::DrawFitsInFile(Int_t cat) {
  ...
  // If cat != 0, only draw the fits of category cat. Default of cat is 0.
  //
  Int_t i,nb,N,cati;
  Char_t c = 'n';
  TSplineFit *fit;
...
void TSplineFit::DrawHere(Double_t ymin,Double_t ymax) {
  // Identical to DrawFit, but do not use TwoPadDisplay!
  // For 1D case, draws superimposed graph of the measured points and of the fit.
  // For 2D or 3D cases, show only the fit, not the data. To see the data, call
  //  DrawGata() instead.
  // The 1st argument "option", is the drawing option for 2D or 3d fits. Default "LEGO2"
...
TSplineFit *TSplineFit::FindFit(const Text_t *name,Int_t cat,Bool_t storeit) {
  ...
  if (!found) {
    ...
    if (found) {
      ...
      // ??? Is it right to delete the fit ??? yes
      delete fit;
      fit = 0;
    }
    fgFitFile->Close();
...
Double_t TSplineFit::GetRandom(Int_t M,Double_t p,Bool_t dbg) {
  ...
  const Double_t minus = -1.0;
  Double_t z = minus;
  TString FamilyName,NewName;
  Int_t L;
  if (fNbInFamily==0) {
    Int_t kfirst;
    TSplineFit *fitnew, *fitold;
    if (!TSplineFit::fgFits->IsSorted()) TSplineFit::fgFits->Sort();
    if (M==1) z = GetRandom();
    else {
      Int_t i      = 0;
      Bool_t found = kFALSE;
      fitnew = this;
      if (dbg) {
        FamilyName = fitnew->GetName();
        L = FamilyName.Index("__");
        FamilyName.Resize(L);
      }
      Double_t pnew,pold;
      pnew = fParameter;
      if (pnew>=p) {
        ...
        while ((!found) && (i<M)) {
          ...
          if (dbg) {
            NewName = fitnew->GetName();
            L = NewName.Index("__");
            NewName.Resize(L);
            if (FamilyName.CompareTo(NewName.Data())) {
              cout << "TSplineFit::GetRandom ERROR fitnew not of family" << endl;
              cout << "TSplineFit::GetRandom ERROR fgFits not sorted" << endl;
            }
          }
          pold = pnew;
...
Bool_t TSplineFit::GetSpline(Int_t i,Double_t &a,Double_t &b,Double_t &c,Double_t &d) const {
...
Bool_t TSplineFit::GetSpline(Double_t x,Double_t &a,Double_t &b,Double_t &c,Double_t &d) const {
  //  Give the coefficients a,b,c,d ( y = a + b*x +c*x*x + d*x*x*x ) of the spline of
...
Bool_t TSplineFit::GetSplineNN(Int_t i,Double_t &a,Double_t &b,Double_t &c,Double_t &d) const {
  //  Give the coefficients a,b,c,d ( y = a + b*x +c*x*x + d*x*x*x ) of the spline of
  ...
  switch (fType) {
    case NotDefined:
    case LinInterpol:
      cout << "TSplineFit::GetSplineNN ERROR:" << endl;
      cout << "  No spline defined!" << endl;
      break;
    case SplineInterpol:
      if ((i>=0) && (i<fN)) {
        inside = kTRUE;
        Double_t x0,y0,sb,sc,sd,x02,x03;
        fInterpolation->GetCoeff(i,x0,y0,sb,sc,sd);
        x02 = x0*x0;
        x03 = x02*x0;
        a   = y0 - sb*x0 + sc*x02 - sd*x03;
        b   = sb  - 2*sc*x0 + 3*sd*x02;
        c   = sc - 3*sd*x0;
        d   = sd;
      }
      break;
    ...
    case SplineFit3D:
      cout << "TSplineFit::GetSplineNN ERROR:" << endl;
      cout << "  GetSplineNN not valid for 2D or 3D fits" << endl;
      break;
  }
  return inside;
}
Bool_t TSplineFit::GetSplineNN(Double_t x,Double_t &a,Double_t &b,Double_t &c,Double_t &d) const {
  //  Give the coefficients a,b,c,d ( y = a + b*x +c*x*x + d*x*x*x ) of the spline of
...
void TSplineFit::InitRef() {
  // Initialization of references of SplineFit
  TAuthor *a;
  fgRef = new TReference("SplineFit",
    "Handling of variable parameters by fit of splines","3_7",
    "http://gentit.home.cern.ch/gentit/splinefit/");
  fgRef->SetFramework("ROOT");
  fgRef->SetLanguage("C++");
...
void TSplineFit::InitTwoPad() {
  // Book canvas with 1 pad
  if (!fgRef) InitRef();
  if (!gTwoPad) new TwoPadDisplay(fgRef,5,20);
  gTwoPad->SetStateOfPads(OnePad);
  gTwoPad->SetButton(5,"Next","TSplineFit::DrawNextInCollection();");
}
...
void TSplineFit::MinMax(Bool_t &ismin,Double_t &xmin,Double_t &ymin,Bool_t &ismax,
...
void TSplineFit::NameFile(const char *name) {
  // Give a name to the database file containing fits
  if (!fgFileName) fgFileName = new TString(name);
}
void TSplineFit::NameProg(const char *name) {
  // Give a name to this program
  if (!fgRef) InitRef();
  fgRef->SetName(name);
}
void TSplineFit::NameWeb(const char *name) {
  // Give a web address for info on this program
  if (!fgRef) InitRef();
  fgRef->SetWebSite(name);
}
...
void TSplineFit::ShowFitsInCollection() {
  //  Shows all fits in the collection fgFits.
  Int_t i,N;
  TSplineFit *fit;
  N = fgFits->GetEntries();
  if (N>0) {
...
Bool_t TSplineFit::SolveLeft(Double_t &x,Double_t y0,Bool_t interval,Double_t xmin,
  Double_t xmax) {
...
void TSplineFit::WriteCollection() {
  // Write collection to the open file
  if (fgFits) {
    if (fgFits->GetEntries()) fgFits->Write("AllFits",1);
  }
}
