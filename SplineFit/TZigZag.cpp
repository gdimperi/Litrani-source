// @(#)root/html:$Id: TZigZag.cpp 2008-06-11
...
TZigZag::TZigZag(Int_t nx,Double_t xmin,Double_t xmax,Int_t ny,Double_t ymin,
  Double_t ymax) {
...
Bool_t TZigZag::IsInside(Double_t xi,Double_t yi,Double_t x, Double_t y,Double_t xc,
  Double_t yc,Double_t xl,Double_t xr,Double_t yl,Double_t yr) const {
...
Bool_t TZigZag::IsInside(Double_t xi,Double_t yi,Double_t zi,Double_t x, Double_t y,
  Double_t z,Double_t xc,Double_t yc,Double_t zc,Double_t xl,Double_t xr,Double_t yl,
  Double_t yr,Double_t zl,Double_t zr) const {
...
Bool_t TZigZag::PointsNear(Double_t x, Double_t y, Double_t &yi,TArrayD &Tn, TArrayD &Yn) const {
