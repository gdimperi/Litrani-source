...
#above ROOT, like SplineFit, Litrani, or the programs you may have developed yourself.
...
#to call entries of an other of your modules or entries of SplineFit or Litrani.
...
#
#   NMAKE /f "makefile.mak" CFG="Release"        or
#   NMAKE /f "makefile.mak" CFG="Debug"
#
ObjSuf        = obj
SrcSuf        = cpp
ExeSuf        = .exe
